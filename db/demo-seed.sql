...
INSERT INTO products (id, slug, name, price, price_label, cooling_kw, heating_kw, hero_image_url, hero_image_alt, short_description, installation_cost, is_front_page, aircon_type, meta_title, meta_description, family_code, family_name, category_slug, category_label, install_summary, brochure_label, brochure_href, overview, best_for_json, spec_notes_json, content_html, product_images_json, published, updated_at)
VALUES ('product-starter-implementation', 'starter-implementation', 'Starter Implementation', NULL, 'Demo', 0, 0, '', '', 'A generic product-style record for testing repeatable CMS content.', 'Demo only', 1, 'generic', 'Starter Implementation | Clastro Demo', 'A generic product-style record for testing repeatable CMS content.', 'DEMO', 'Clastro Demo', 'cms-packages', 'CMS Packages', 'Demo install summary', 'Demo brochure', '#', 'Use this record to test product detail pages, product galleries, pricing labels, and rich product copy.', '["Testing product cards","Testing detail pages","Testing CMS fields"]', '["This is a generic starter record."]', '<p>Use this record to test product detail pages, product galleries, pricing labels, and rich product copy.</p><h2>Editable product copy</h2><p>Update this rich text from the Products tab in the admin.</p>', '[]', 1, CURRENT_TIMESTAMP);

INSERT INTO products (id, slug, name, price, price_label, cooling_kw, heating_kw, hero_image_url, hero_image_alt, short_description, installation_cost, is_front_page, aircon_type, meta_title, meta_description, family_code, family_name, category_slug, category_label, install_summary, brochure_label, brochure_href, overview, best_for_json, spec_notes_json, content_html, product_images_json, published, updated_at)
VALUES ('product-client-upgrade-kit', 'client-upgrade-kit', 'Client Upgrade Kit', NULL, 'Internal', 0, 0, '', '', 'A second dummy record for checking lists, filters, and detail-page rendering.', 'Demo only', 1, 'generic', 'Client Upgrade Kit | Clastro Demo', 'A second dummy record for checking lists, filters, and detail-page rendering.', 'DEMO', 'Clastro Demo', 'cms-packages', 'CMS Packages', 'Demo install summary', 'Demo brochure', '#', 'This entry represents a packaged CMS upgrade path for existing client sites.', '["Testing product cards","Testing detail pages","Testing CMS fields"]', '["This is a generic starter record."]', '<p>This entry represents a packaged CMS upgrade path for existing client sites.</p><h2>Editable product copy</h2><p>Update this rich text from the Products tab in the admin.</p>', '[]', 1, CURRENT_TIMESTAMP);
